...
// Esta URL se gestiona a través de la variable de entorno VITE_N8N_WEBHOOK_URL
// en tu plataforma de despliegue (ej. Vercel, Netlify).
export const N8N_WEBHOOK_URL = (import.meta as any).env.VITE_N8N_WEBHOOK_URL;

// --- CONTACT FORM CONFIGURATION ---
// Esta URL se gestiona a través de la variable de entorno VITE_N8N_CONTACT_FORM_WEBHOOK_URL.
export const N8N_CONTACT_FORM_WEBHOOK_URL = (import.meta as any).env.VITE_N8N_CONTACT_FORM_WEBHOOK_URL;
...
export const FOUNDERS: Founder[] = [
    {
      ...
      description: 'Soy Facundo Lobos, cofundador y co-CEO de DLXTech. Nací en Buenos Aires el 10 de Julio de 1990 y, con el tiempo, decidí mudarme a Villa Gesell en busca de un nuevo rumbo que me permitiera crecer personal y profesionalmente. Durante muchos años trabajé en el área administrativa, pero fue recién de grande cuando descubrí mi verdadera pasión: la tecnología y la programación. Ese descubrimiento marcó un antes y un después en mi vida. Me formé como Analista de Sistemas y desde entonces no he dejado de enfocarme en encontrar soluciones tecnológicas que realmente marquen la diferencia para las personas y las empresas. Vengo del mundo del deporte; jugué al béisbol durante gran parte de mi vida, lo que me enseñó la importancia de la disciplina, el compromiso y el trabajo en equipo. Hoy aplico esos mismos valores en DLXTech, liderando junto a mi socio un proyecto que nació con una visión clara: crear tecnología que resuelva problemas reales con profesionalismo, innovación y pasión.',
    ...
    },
    {
      ...
      title: 'Co-Founder & CEO',
      description: 'Mi nombre es Emiliano Dzisiuk, nací el 21 de Junio de 1991 en Buenos Aires, donde sigo viviendo actualmente. Durante varios años trabajé como docente, una experiencia que me formó tanto personal como profesionalmente, y me permitió desarrollar habilidades clave como la comunicación, la empatía y el pensamiento analítico. Con el tiempo, ya de más grande, descubrí un profundo interés por el mundo de la tecnología y la programación. Esa curiosidad me llevó a capacitarme como Analista de Sistemas y a redirigir por completo mi camino profesional. Además, el deporte siempre fue una parte fundamental de mi vida. Juego al básquet desde muy chico, y gracias a eso aprendí el valor del trabajo en equipo, la constancia y la toma de decisiones bajo presión. Hoy aplico todo ese aprendizaje en mi rol como cofundador y co-CEO de DLXTech, donde junto a mi socio lideramos con una visión compartida: crear soluciones tecnológicas que sean útiles, escalables y pensadas para transformar realidades. Estoy convencido de que la tecnología puede mejorar vidas, y ese es el motor que me impulsa cada día.',
